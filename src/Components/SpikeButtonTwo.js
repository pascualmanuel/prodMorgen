      ...
      {/* <div>
            ...
            >
              <svg
                ...
                onMouseEnter={() => {
                  const cls2 = document.getElementsByClassName("spike-b2-cls-2")[0];
                  const cls4 = document.getElementsByClassName("spike-b2-cls-4")[0];
                  cls2.style.transform = "translate(10px, -10px)";
